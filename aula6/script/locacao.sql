...
drop table precocategoriafilial;
drop table veiculo;
...
CREATE TABLE precocategoriafilial(
...
('12345678911231','Sao Paulo – Centro','12345678911231'),
('12345678911234','Porto Alegre – Aeroporto','12345678911231'),
('12345678911235','Rio Grande','12345678911231');

INSERT INTO cliente (documento, nome, datadenascimento,PFPJ, quantlocacoes, filial) values
...
INSERT INTO categoriaveiculo (codigocat,nome) values
('1','SUV'),
('2','camionete'),
('3','compacto');

INSERT INTO precocategoriafilial (categoria,filial,valordadiaria) values
('1','12345678911235',480),
('2','12345678911235',480),
('3','12345678911235',480),
('1','12345678911234',480),
('2','12345678911234',480),
('3','12345678911234',480);


INSERT INTO veiculo (marca, modelo, placa, categoria, filial,ano, apolice, descricao, dataultimarevisao) values
('Renault','Duster 1.6','ABC1A23','1', '12345678911235','2019','ABC12345/2020','câmbio manual, ar-condicionado, direção hidráulica, vidros e travas elétricas, freios ABS', '2020-08-31 09:00:00'),
('volkswagen','gremio','XYZ1A35','2','12345678911235','2020','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('volkswagen','gremio','XYZ1A36','2','12345678911235','2018','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('volkswagen','flamengo','XYZ1A37','2','12345678911235','2021','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('volkswagen','fusca','XYZ1A38','3','12345678911234','1970','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('volkswagen','gol','XYZ1A39','3','12345678911235','2005','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('volkswagen','gol','XYZ1A40','3','12345678911235','2010','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('Renault','kwid','XYZ1A41','3','12345678911235','2015','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('Renault','clio','XYZ1A42','3','12345678911234','2018','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('Renault','barcelona','XYZ1A43','3','12345678911235','2017','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('chevrolet','celta','XYZ1A44','3','12345678911234','1970','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('chevrolet','celta','XYZ1A45','3','12345678911235','2005','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('chevrolet','celta','XYZ1A46','3','12345678911235','2010','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('chevrolet','celta','XYZ1A47','3','12345678911234','2015','ABC12345/2020',NULL,'2021-01-01 09:00:00'),
('chevrolet','celta','XYZ1A48','3','12345678911235','2018','ABC12345/2020',NULL,'2021-07-01 09:00:00'),
('fiat','uno','XYZ1A49','3','12345678911234','2017','ABC12345/2020',NULL,'2021-07-01 09:00:00'),
('fiat','palio','XYZ1A50','3','12345678911235','2018','ABC12345/2020',NULL,'2021-07-01 09:00:00'),
('fiat','uno','XYZ1A51','3','12345678911235','2017','ABC12345/2020',NULL,'2021-07-01 09:00:00'),
('fiat','palio','XYZ1A52','3','12345678911235','2018','ABC12345/2021',NULL,'2021-07-01 09:00:00'),
('Renault','Duster 1.6','XYZ1A34','1','12345678911235','2019','ABC12345/2020','câmbio manual, ar-condicionado, direção hidráulica, vidros e travas elétricas, freios ABS','2020-08-25 09:00:00');

INSERT INTO condutor (documento, nome, datadenascimento, genero, filial) values
