...
(case 
    ...
    when extract(month from current_date) <= 6 then locacao.dataretirada >= date_trunc('year', current_date - interval '1' year)
                                            and
                                            (case 
                                                when extract(month from current_date) =1  then locacao.dataretirada >= date_trunc('month', current_date - interval '6' month)
                                                when extract(month from current_date) =2  then locacao.dataretirada >= date_trunc('month', current_date - interval '7' month)
                                                when extract(month from current_date) =3  then locacao.dataretirada >= date_trunc('month', current_date - interval '8' month)
                                                when extract(month from current_date) =4  then locacao.dataretirada >= date_trunc('month', current_date - interval '9' month)
                                                when extract(month from current_date) =5  then locacao.dataretirada >= date_trunc('month', current_date - interval '10' month)
                                                when extract(month from current_date) =6  then locacao.dataretirada >= date_trunc('month', current_date - interval '11' month)
                                                       
                                            end ) 
    when extract(month from current_date) > 6 then  date_part('month',locacao.dataretirada) <= date_part('month', TIMESTAMP '2017-06-01')
    and
                                            (case 
                                                when extract(month from current_date) =7  then locacao.dataretirada >= date_trunc('month', current_date - interval '6' month)
                                                when extract(month from current_date) =8  then locacao.dataretirada >= date_trunc('month', current_date - interval '7' month)
                                                when extract(month from current_date) =9  then locacao.dataretirada >= date_trunc('month', current_date - interval '8' month)
                                                when extract(month from current_date) =10  then locacao.dataretirada >= date_trunc('month', current_date - interval '9' month)
                                                when extract(month from current_date) =11 then locacao.dataretirada >= date_trunc('month', current_date - interval '10' month)
                                                when extract(month from current_date) =12 then locacao.dataretirada >= date_trunc('month', current_date - interval '11' month)       
                                            end) 	
			end 
)
...
(case 
    ...
    when extract(month from current_date) <= 6 then contacorrente.dataaberturacc >= date_trunc('year', current_date - interval '1' year)
                                            and
                                            (case 
                                                when extract(month from current_date) =1  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '6' month)
                                                when extract(month from current_date) =2  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '7' month)
                                                when extract(month from current_date) =3  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '8' month)
                                                when extract(month from current_date) =4  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '9' month)
                                                when extract(month from current_date) =5  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '10' month)
                                                when extract(month from current_date) =6  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '11' month)
                                                       
                                            end ) 
    when extract(month from current_date) > 6 then  date_part('month',contacorrente.dataaberturacc) <= date_part('month', TIMESTAMP '2017-06-01')
    and
                                            (case 
                                                when extract(month from current_date) =7  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '6' month)
                                                when extract(month from current_date) =8  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '7' month)
                                                when extract(month from current_date) =9  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '8' month)
                                                when extract(month from current_date) =10  then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '9' month)
                                                when extract(month from current_date) =11 then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '10' month)
                                                when extract(month from current_date) =12 then contacorrente.dataaberturacc >= date_trunc('month', current_date - interval '11' month)       
                                            end) 	
			end 
)
group by agencia;
